  ...
  return (
    <>
      ...
      <Link style={{ color: 'white' ,textDecoration: 'none'}} to="/" >
                <p style={{ fontSize: '20px' }}>CodeForcesVisualizer</p>
              </Link>
